...
if (isset($_POST['update_account'])) {
    ...
    $update_c = "UPDATE customer SET customer_name='$c_name', customer_email='$c_email', customer_password='$c_pass', customer_country='
    $c_country', customer_city='$c_city', customer_contact='$c_contact', customer_address='$c_address', customer_image='$c_image' 
    ...
    if ($run_c) {
        ...
        echo "<script>alert('Update Account Fail. Please Try again.!')</script>";
    }
}
